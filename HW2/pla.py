...
def PLA(N, lr_weights, lr_target_slope, lr_target_b):
...
def PLA_test(N, runs, lr_weights, lr_target_slope, lr_target_b):
	iterations, prob = 0.0, 0.0
	for i in range(runs):
		run_iterations, run_miss_prob = PLA(N, lr_weights, lr_target_slope, lr_target_b)
